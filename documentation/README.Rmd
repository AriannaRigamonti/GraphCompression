---
title: "Graph Compression Documentation"
author: 
  name: "Arianna Rigamonti - 252321 Bioinformatics for Computational Genomics 2024 - Scientific Programming course"
  affiliation: "Project 7: Graph Compression - Programming language: Python (v. 3.12.0)"
output: 
  html_document:
    toc: True
---
...
```
where:
- `PROTEIN_NAME` is the name or identifier of the protein.
...
- `OVERWRITE` is a boolean flag to specify whether to overwrite existing files.
...
- `overwrite`: Boolean flag to specify whether to overwrite existing files.
...
```
![Original_graph](/Users/ariannarigamonti/Library/CloudStorage/OneDrive-UniversitàdegliStudidiMilano/Università/Bioinformatics/I anno/II semestre/Scientific programming/Projects/Python/GraphCompression/example_output/output_files/original_graph/TP53/TP53_20_nodes_original_graph.png)
...
```
![Compressed_graph](/Users/ariannarigamonti/Library/CloudStorage/OneDrive-UniversitàdegliStudidiMilano/Università/Bioinformatics/I anno/II semestre/Scientific programming/Projects/Python/GraphCompression/example_output/output_files/compressed_graph/TP53/TP53_20_to_10_compressed_graph_.png)
